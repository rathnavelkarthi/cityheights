...
export default function EventsPage() {
  // Mapping local assets to the constant data
  const featured = {
    ...FEATURED_EVENT,
    ...
    stats: [
      ...
      { label: "Artists", value: "6 Headliners", icon: Music },
    ]
  };
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <Image
          ...
          alt="Cinematic luxury gala event"
          fill
          priority
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
          ...
          <AnimatedSection delay={0.3}>
            <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto leading-relaxed font-light">
              Where the city&apos;s elite converge. Discover our upcoming curated experiences and signature galas.
            </p>
          </AnimatedSection>
      ...
      {/* ══════════════════════════════════════════════════
          SECTION 2 — FEATURED EVENT (Editorial)
          ══════════════════════════════════════════════════ */}
            ...
            <div className="flex flex-col lg:flex-row gap-16 lg:items-center">
                ...
                <div className="absolute -bottom-8 -right-4 md:right-8 flex flex-col gap-3">
                  {featured.stats.map((stat, i) => (
                    <AnimatedSection key={stat.label} delay={0.5 + i * 0.1}>
                      <div className="bg-neutral-900/90 backdrop-blur-xl border border-white/10 p-4 rounded-xl shadow-2xl min-w-[160px]">
              ...
              <div className="flex-1 lg:pl-8">
                <AnimatedSection delay={0.2}>
                  <Badge className="bg-white/5 text-white/50 border-white/10 hover:bg-white/10 transition-colors uppercase tracking-[0.2em] px-4 py-1 mb-6 rounded-full text-[10px]">
                    Featured Production
                  </Badge>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12 border-t border-white/5 pt-10">
                    <div className="space-y-1">
                      <p className="text-xs uppercase tracking-widest text-white/20">Date & Time</p>
                    ...
                    <div className="space-y-1">
                      <p className="text-xs uppercase tracking-widest text-white/20">Location</p>
                      <div className="flex items-center gap-2 text-white/60">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <AnimatedSection>
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
              ...
              <Button variant="link" className="text-white/40 hover:text-white p-0 h-auto group text-xs uppercase tracking-widest">
                View Full Calendar
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-neutral-950/50 border border-white/5 aspect-[4/5] flex flex-col">
                  ...
                  <div className="relative h-2/3 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-black/50 backdrop-blur-md text-white/60 border-white/10 text-[9px] uppercase tracking-widest px-3 py-1">
                        {event.category}
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="relative flex-1 p-8 flex flex-col justify-between">
                    ...
                    <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                      ...
                      <div className="w-10 h-10 rounded-full border border-white/5 flex items-center justify-center group-hover:bg-white group-hover:border-white transition-all duration-300">
      ...
      <section className="py-32 bg-neutral-950 overflow-hidden relative">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6">
          <div className="bg-neutral-900 p-12 md:p-24 rounded-3xl border border-white/5 text-center relative overflow-hidden">
             {/* Decorative watermark */}
             <Sparkles className="absolute -top-10 -left-10 h-40 w-40 text-white/[0.02] rotate-12" />
             ...
             <AnimatedSection>
              ...
              <p className="text-white/40 text-lg max-w-lg mx-auto mb-10 leading-relaxed font-light">
                Planning a milestone event? Let City Heights transform your concept into a legendary production.
              </p>
              <Button asChild size="lg" className="rounded-full bg-white text-black hover:bg-white/90 px-12 py-7 group">
                <Link href="/contact">
                  Start Planning
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </Link>
