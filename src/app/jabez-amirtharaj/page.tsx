...
export const metadata: Metadata = {
  title: "Jabez Amirtharaj | Founder of City Heights Events",
  description: "Jabez Amirtharaj is the founder of City Heights Events, specialized in luxury event management, bespoke weddings, and large-scale corporate productions in Chennai.",
  alternates: {
    canonical: "/jabez-amirtharaj",
  },
  openGraph: {
...
export default function JabezFounderPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Person",
    "name": "Jabez Amirtharaj",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tight mb-6 font-[family-name:var(--font-poppins)]">
                Jabez <span className="text-gold">Amirtharaj</span>
              </h1>
      ...
      <footer className="py-12 border-t border-white/5 bg-neutral-950">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-xs text-white/20 tracking-widest uppercase">
            © {new Date().getFullYear()} Jabez Amirtharaj • City Heights Events
          </div>
